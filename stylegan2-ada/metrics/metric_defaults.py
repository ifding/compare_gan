...
metric_defaults = EasyDict([(args.name, args) for args in [
    ...
    EasyDict(name='clustering',           class_name='metrics.clustering.CL',             num_images=50000, num_splits=10, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None)),
